...
public class BerlinClockFixture {
    ...
    // These dependencies would be 'normally' provided by DI container
    private TimeConverter berlinClock = new BerlinClockTimeConverter(new NormalTimeFactory(), new BerlinTimePrinter());
